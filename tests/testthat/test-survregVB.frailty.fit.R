...
test_that("survregVB.frailty.fit", {
  ...
  expected <- list(
    ...
    Sigma = matrix(
      c(
        0.50246823, -0.45647333, -0.03885537,
    ...
    tau = setNames(
      c(
        -0.207712506, 0.703780589, 0.434283093, 0.127487655, 1.612282757,
    ...
    sigma = setNames(
      c(
        0.224621934, 0.162451332, 0.162451332, 0.188527839, 0.188527839,
