...
test_that("test diff_gamma", {
  expect_equal(diff_gamma(tau, sigma_squared, lambda, eta, cluster),
               -14.93795024)
  expect_equal(diff_gamma(tau.15, sigma_squared.15, lambda, eta.15, cluster),
               -14.6644959)
})
...
test_that("test elbo_cluster", {
  expect_equal(elbo_cluster(Y, X, delta, alpha_0, omega_0, mu_0, v_0, lambda_0,
                            eta_0, alpha, omega, mu, Sigma, tau, sigma_squared, lambda,
                            eta, expectation_b, cluster),
               -1607.13831)
  expect_equal(elbo_cluster(log(T.15), X, delta, alpha_0, omega_0, mu_0, v_0, lambda_0,
